...
\begin{figure}[h!] \centering \includegraphics[width=0.75\linewidth]{figures/theory/image-recognition/normalization.png} \caption[Normalization process in image preprocessing]{Illustration of the normalization process applied to an image, adjusting pixel values to a standard range for model input.} \label{fig:normalization} \end{figure}
