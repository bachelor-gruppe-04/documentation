...
\textbf{Scaling} in image processing and \gls{ml} involves resizing images to the format required by the model, as shown in Figure \ref{fig:scaling} \cite{brownlee:normalization}. 
