...
The participant group included individuals from diverse backgrounds and a wide age range, spanning 18 to 55 years, ranging from experienced chess players to those unfamiliar with the game. Their technical expertise varied as well, encompassing computer science students and non-technical individuals, such as stay-at-home parents. In total, eight participants took part in this test, excluding the developers and project stakeholders \\
