...
Research into existing chess digitization methods, we identified a publicly available solution developed by Peter Batchelor, Tom Richardson, and other contributors. This solution serves as the foundation for our approach. It utilizes two \glspl{cnn}: one for detecting chess pieces and another for locating the four corners of the chessboard \cite{lichess:chesscam}.


\subsection{Piece Detection Model}
The piece detection is a LeYOLO ONNX model.
