...
\begin{itemize} 
\item The first 4 values are offset values that adjust the position and size of each anchor box so that it better aligns with a detected piece. These offsets are relative to predefined anchor boxes, as illustrated in Table \ref{tab:offset-table}.
\end{itemize}
