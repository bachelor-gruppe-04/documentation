...
\subsection{}
The chesscam repo had multiple options to choose between, both pytorch or ONNX. ONNX was chosen (then explain here why would choose that). To find the inputs and outputs of the models netron was used. 
