...
The user also has the option to download the \gls{pgn} file for a selected game. On the board view page, a dedicated button allows the user to download the PGN file corresponding to the currently displayed game. When this button is clicked, the file is saved locally to the user's computer, as shown in Figure~\ref{fig:download-pgn}. \\
