...
\begin{table}[htbp]
\centering
\caption{Failure causes by board type}
\begin{tabular}{lccc}
\toprule
...
For a detailed breakdown of the chess games, including the \gls{eco}, failure points, and piece-wise failure statistics for each board type, see Appendix X.
