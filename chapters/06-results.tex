...
\begin{table}[h!]
    ...
    \begin{tabular}{L{0.15\linewidth}L{0.25\linewidth}L{0.5\linewidth}}
        ...
        \texttt{GET} & \texttt{/boards} & Returns a list of all board IDs currently active. \\
        \texttt{GET} & \texttt{/video/\{id\}} & Streams MJPEG (Motion JPEG) video from a specific camera (board ID). \\
