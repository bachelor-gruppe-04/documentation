...
% These requirements ensure that the solution is both practical and accessible, addressing the needs of the organization while adhering to technical and operational constraints.

\section{Structure of the Thesis}

% This thesis is organized into six chapters, each addressing a specific aspect of the project. The structure is designed to provide a logical flow, from the problem definition to the final conclusions. The chapters are outlined as follows:
...
% This structure ensures a comprehensive and systematic presentation of the project, enabling readers to follow the development process and understand the contributions of this work.
